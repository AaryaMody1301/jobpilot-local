...
APPLICATION_TRANSITIONS: Mapping[ApplicationState, AbstractSet[ApplicationState]] = {
    ...
    ApplicationState.NEEDS_REVIEW: {ApplicationState.ELIGIBILITY_CHECK, ApplicationState.BLOCKED},
    ...
    ApplicationState.INSPECTING: {ApplicationState.FILLING, ApplicationState.BLOCKED, ApplicationState.FAILED, ApplicationState.STALE},
    ApplicationState.FILLING: {ApplicationState.READY_TO_SUBMIT, ApplicationState.BLOCKED, ApplicationState.FAILED, ApplicationState.STALE, ApplicationState.QUEUED},
    ApplicationState.READY_TO_SUBMIT: {ApplicationState.SUBMITTING, ApplicationState.BLOCKED, ApplicationState.STALE, ApplicationState.QUEUED},
