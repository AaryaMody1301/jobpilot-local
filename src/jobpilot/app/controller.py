...
class ApplicationController:
    ...
    def start(self) -> dict[str, Any]:
        with self._lock:
            ...
            self.database.record_foundation_activity(self.session_id, "start", "Desktop session started")
            return self.snapshot()
    ...
    def pause(self) -> dict[str, Any]:
        with self._lock:
            ...
            self.database.set_runtime_session_state(self.session_id, self._state)
            self.database.record_foundation_activity(self.session_id, "pause", "Desktop session paused")
            return self.snapshot()
    ...
    def stop(self) -> dict[str, Any]:
        with self._lock:
            ...
            self._state = SessionState.IDLE
            self.database.set_runtime_session_state(self.session_id, self._state)
            self.database.record_foundation_activity(self.session_id, "stop", "Desktop session stopped; app remains open")
            return self.snapshot()
