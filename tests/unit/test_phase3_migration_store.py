...
def test_phase3_migration_upgrades_phase2_database_without_losing_later_additions(tmp_path: Path) -> None:
    ...
    with Database(database_path, MIGRATIONS) as db:
        assert db.apply_migrations() == ["004_phase3_local_ai.sql", "005_phase4_tailoring.sql", "006_phase4_tailoring_safety.sql", "007_phase5_jobs.sql", "008_phase6_applications.sql", "009_phase8_orchestration.sql", "010_job_application_workspace.sql"]
